            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('customer.register') }}">
                        ...
                        <div class="form-group row">
                            <label for="neighbourhood" class="col-md-4 col-form-label text-md-right">Bairro</label>

                            <div class="col-md-6">
                                <input id="neighbourhood" type="text" class="form-control @error('neighbourhood') is-invalid @enderror" name="neighbourhood" value="{{ old('neighbourhood') }}" required autocomplete="neighbourhood">
                        ...
                        <div class="form-group row">
                            <label for="reference" class="col-md-4 col-form-label text-md-right">Referência</label>
