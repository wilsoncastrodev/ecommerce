<div class="bg-gradient-blue text-center text-white font-size-sm mb-3">
    <div class="bg-overlay-transparent py-3">
        ...
        <div>
            <a class="text-white text-decoration-underline" 
               href="https://wilsoncastro.dev/#politica-privacidade" 
               target="_blank">
            Clique aqui</a> para ver a Política de Privacidade.
        </div>
    </div>
</div>